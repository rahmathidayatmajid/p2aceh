            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                    ...
                    <div class="search-element">
                        ...
                        <div class="search-result">
                            ...
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30"
                                        src="<?=base_url()?>/template/admin/assets/img/products/product-3-50.png"
                                        alt="product">
                            ...
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30"
                                        src="<?=base_url()?>/template/admin/assets/img/products/product-2-50.png"
                                        alt="product">
                                    Drone X2 New Gen-7
                                </a>
                            </div>
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30"
                                        src="<?=base_url()?>/template/admin/assets/img/products/product-1-50.png"
                                        alt="product">
                                    Headphone Blitz
                                </a>
                            </div>
                ...
                <ul class="navbar-nav navbar-right">
                        ...
                        <div class="dropdown-menu dropdown-list dropdown-menu-right">
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image"
                                            src="<?=base_url()?>/template/admin/assets/img/avatar/avatar-5.png"
                                            class="rounded-circle">
                                    </div>
                                    <div class="dropdown-item-desc">
                                        <b>Alfa Zulkarnain</b>
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            ...
                            <img alt="image" src="<?=base_url()?>/template/admin/assets/img/avatar/avatar-1.png"
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="<?=site_url()?>">P2ACEH</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="<?=site_url()?>">P2</a>
                    </div>
                    ...
                    <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
                        <a href="https://p2aceh.com/docs" class="btn btn-primary btn-lg btn-block btn-icon-split">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2022 <div class="bullet"></div> Design By <a
                        href="https://p2aceh.com/">P2ACEH.com</a>
                </div>
